...
class ParserTest extends AnyFreeSpec {
  ...
  roundtrip[IProduct](Index, "(1 * 2)")
  roundtrip[IDivision](Index, "(1 / 2)")
  roundtrip[IRemainder](Index, "(1 % 2)")
